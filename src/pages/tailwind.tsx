      ...
      <div className="mb-4 border-b border-gray-200">
        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center">
          <li className="mr-2" role="presentation">
            <button className="inline-block p-4" id="layout-tab" type="button">Layout</button>
          </li>
          <li className="mr-2" role="presentation">
            <button className="inline-block p-4" id="flexbox-tab" type="button">flexbox</button>
          </li>
          <li className="mr-2" role="presentation">
            <button className="inline-block p-4" id="space-size-tab" type="button">space-size</button>
          </li>
          <li role="presentation">
            <button className="inline-block p-4" id="typography-tab" type="button">typography</button>
          </li>
        </ul>
      </div>
      <div id="myTabContent">
        ...
        <div className="hidden p-4 rounded-lg bg-gray-50" id="flexbox">
          <Flexbox />
        </div>
        <div className="hidden p-4 rounded-lg bg-gray-50" id="space-size">
          <SpaceSize />
        </div>
        <div className="hidden p-4 rounded-lg bg-gray-50" id="typography">
          <Typography />
        </div>
      </div>
    </div>
